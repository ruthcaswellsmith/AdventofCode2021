...
class Notes():
    ...
    def __init__(self, notes: List[Note]):
        ...
        self.notes = notes
        self.unique_lengths = [len(NUMBERS[number]) for number in UNIQUE_NUMBERS]
    ...
    def get_answer(self, part: PART):
        ...
        if part == PART.PART_ONE:
            ...
            for note in self.notes:
                ...
                temp = note.count_segments()[self.unique_lengths]
                answer += note.count_segments()[self.unique_lengths].sum()
    ...
    def decode_output_values(self):
        ...
        self.output_values = []
        for note in self.notes:
            self.output_values.append(note.decode_output_values())
...
if __name__ == "__main__":
    ...
    notes.get_mappings()
    notes.decode_output_values()
    answer = notes.get_answer(PART.PART_TWO)
